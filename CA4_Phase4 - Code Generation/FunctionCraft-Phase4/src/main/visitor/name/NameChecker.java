...
public class NameChecker extends Visitor<Void> {
    ...
    public Void visit(Program program) {
        ...
        for (FunctionDeclaration funcDec : program.getFunctionDeclarations()) {
            ...
            try {
                ...
                duplicateFuncId += 1;
                String freshFuncName = funcItem.getName() +  "#" + duplicateFuncId;
    ...
    public Void visit(ForStatement forStatement) {
        ...
        SymbolTable.push(SymbolTable.top.copy());
        forEachAccept(forStatement.getRangeExpression().getRangeExpressions(), exp -> exp.accept(this));
        forEachAccept(forStatement.getLoopBodyStmts(), exp -> exp.accept(this));
        SymbolTable.pop();
        return null;
    }
    ...
    public Void visit(AssignStatement assignStatement) {
        ...
        if(assignStatement.getAssignExpression() instanceof FunctionPointer) {
            ...
            funcDec.setFunctionName(assignStatement.getAssignedId());
            FunctionItem funcItm = new FunctionItem(funcDec);
            try {
