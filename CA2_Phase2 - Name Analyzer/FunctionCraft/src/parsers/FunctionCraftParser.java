	...
	public final PatternMatchingContext patternMatching() throws RecognitionException {
		...
		try {
			...
			match(RPAR);
			        ...
			        Identifier patId = new Identifier((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getText():null));
			        patId.setLine((((PatternMatchingContext)_localctx).patternName!=null?((PatternMatchingContext)_localctx).patternName.getLine():0));
			        Identifier targId = new Identifier((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getText():null));
			        targId.setLine((((PatternMatchingContext)_localctx).targetVar!=null?((PatternMatchingContext)_localctx).targetVar.getLine():0));
			        ((PatternMatchingContext)_localctx).patternRet =  new PatternDeclaration(patId, targId);
			...
			while (_la==PATTERN_MATCHING_SEPARATOR) {
				...
				((PatternMatchingContext)_localctx).c = condition();
				            ...
				            ArrayList<Expression> currentConditions = _localctx.patternRet.getConditions();
				            if (currentConditions == null) {
				                currentConditions = new ArrayList<Expression>();
				            }
				            currentConditions.addAll(((PatternMatchingContext)_localctx).c.conditionRet);
				            _localctx.patternRet.setConditions(currentConditions);
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			((ForStatementContext)_localctx).l = loopBody();
			        ...
			        Identifier forStmtId = new Identifier((((ForStatementContext)_localctx).id!=null?((ForStatementContext)_localctx).id.getText():null));
			        forStmtId.setLine((((ForStatementContext)_localctx).id!=null?((ForStatementContext)_localctx).id.getLine():0));
			        ((ForStatementContext)_localctx).forStRet =  new ForStatement(forStmtId, ((ForStatementContext)_localctx).r.rangeRet, ((ForStatementContext)_localctx).l.loopExps, ((ForStatementContext)_localctx).l.loopStmts, ((ForStatementContext)_localctx).l.loopRetStmt);
	...
	public final MatchPatternStatementContext matchPatternStatement() throws RecognitionException {
		...
		try {
			...
			match(RPAR);
			        ...
			        Identifier patId = new Identifier((((MatchPatternStatementContext)_localctx).id!=null?((MatchPatternStatementContext)_localctx).id.getText():null));
			        patId.setLine((((MatchPatternStatementContext)_localctx).id!=null?((MatchPatternStatementContext)_localctx).id.getLine():0));
			        ((MatchPatternStatementContext)_localctx).matchPatRet =  new MatchPatternStatement(patId, ((MatchPatternStatementContext)_localctx).e.expRet);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((ExpressionContext)_localctx).e2 = eqaulityExpression();
					                  ...
					                  appendExpr.setLine((((ExpressionContext)_localctx).a!=null?((ExpressionContext)_localctx).a.getLine():0));
					                  ArrayList<Expression> appendedsExprs = appendExpr.getAppendeds();
					                  appendedsExprs.add(((ExpressionContext)_localctx).e2.expRet);
					                  appendExpr.setAppendeds(appendedsExprs);
